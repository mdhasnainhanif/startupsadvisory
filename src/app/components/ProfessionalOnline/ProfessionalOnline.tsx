        ...
        <Container maxWidth="xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative z-10">
              <div className="relative group cursor-pointer" onClick={() => setIsPopupOpen(true)}>
                ...
                <div className={`${styles.videoCard} relative rounded-2xl overflow-hidden transition-all duration-300 group-hover:shadow-[#643bff]/60`}>
                  ...
                  <div className="aspect-video bg-gradient-to-br from-[#1a1a2e] to-[#0a0a1a] flex items-center relative overflow-hidden">
                    ...
                    <div className="absolute left-0 top-0 bottom-0 w-[12rem] md:w-[14rem] lg:w-[16rem]">
                      <Image
                    ...
                    <div className="absolute right-0 top-0 bottom-0 left-[12rem] md:left-[14rem] lg:left-[16rem] flex items-center px-4 md:px-6 lg:px-8">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="w-20 h-20 md:w-24 md:h-24 bg-[#643bff] rounded-full flex items-center justify-center shadow-lg shadow-[#643bff]/50 transition-all duration-300 group-hover:scale-110 group-hover:shadow-[#643bff]/70 z-10 pointer-events-auto">
                      <svg
              ...
              {/* Bottom Heading */}
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mt-8 text-center lg:text-left leading-tight">
